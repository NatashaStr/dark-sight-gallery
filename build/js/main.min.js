...
var _vhFix = require("./modules/vh-fix");
var _initChangeHeaderBg = require("./modules/init-change-header-bg");
var _exhibitionsSlider = require("./modules/exhibitions-slider.js");
var _introSlider = require("./modules/intro-slider.js");
var _ymaps = require("./modules/ymaps.js");
var _artPictureAnimation = require("./modules/art-picture-animation");
var _parallax = require("./modules/parallax");
var _scrollToBlock = require("./modules/scroll-to-block");
var _smoothScroller = require("./modules/smooth-scroller.js");
var _splitting = require("./modules/splitting.js");
var _lampInstallationAnimation = require("./modules/lamp-installation-animation.js");
// ---------------------------------
...
function renderContent() {
  ...
  (0, _scrollToBlock.scrollToBlock)();
  (0, _introSlider.initIntroSlider)();
  (0, _smoothScroller.initSmoothScroller)();
  (0, _exhibitionsSlider.initExhibitionsSlider)();
  (0, _splitting.initSplitting)();
  (0, _initChangeHeaderBg.initHeaderThemeChange)();
  (0, _artPictureAnimation.initArtPictureAnimation)();
  (0, _parallax.initParallax)();
  (0, _lampInstallationAnimation.initLampInstallationAnimation)();
  (0, _ymaps.initYMaps)();
  // });
}
...
},{"./modules/art-picture-animation":2,"./modules/exhibitions-slider.js":7,"./modules/init-change-header-bg":8,"./modules/intro-slider.js":9,"./modules/lamp-installation-animation.js":10,"./modules/parallax":11,"./modules/scroll-to-block":12,"./modules/smooth-scroller.js":13,"./modules/splitting.js":14,"./modules/vh-fix":15,"./modules/ymaps.js":16}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initArtPictureAnimation = void 0;
var _gsapMin = require("../vendor/gsap.min.js");
var parallaxImageWrapper = document.querySelector('.art-picture__parallax-image-wrapper');
var image = document.querySelector('.art-picture__parallax-image-wrapper img');
var initArtPictureAnimation = function initArtPictureAnimation() {
  if (parallaxImageWrapper && image) {
    var parallax = _gsapMin.gsap.timeline({
      scrollTrigger: {
...
exports.initArtPictureAnimation = initArtPictureAnimation;

},{"../vendor/gsap.min.js":20}],3:[function(require,module,exports){
"use strict";
...
var Burger = /*#__PURE__*/function () {
  ...
  _createClass(Burger, [{
    ...
    key: "_ifWindowResized",
    value: function _ifWindowResized() {
...
},{"../utils/focus-lock":17,"../utils/scroll-lock":19}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeBurgerColorClass = exports.addBurgerColorClass = void 0;
var burgerMenuIcon = document.querySelector('[data-burger]');
var addBurgerColorClass = function addBurgerColorClass(color) {
  if (burgerMenuIcon) {
    burgerMenuIcon.classList.add("is-".concat(color));
  }
};
exports.addBurgerColorClass = addBurgerColorClass;
var removeBurgerColorClass = function removeBurgerColorClass(color) {
  if (burgerMenuIcon) {
    burgerMenuIcon.classList.remove("is-".concat(color));
  }
};
exports.removeBurgerColorClass = removeBurgerColorClass;
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var HeaderTheme = /*#__PURE__*/function () {
  function HeaderTheme() {
    _classCallCheck(this, HeaderTheme);
    this._header = document.querySelector('[data-header]');
    this._burger = document.querySelector('[data-burger]');
    this._logo = document.querySelector('[data-header-logo]');
  ...
  _createClass(HeaderTheme, [{
    ...
    value: function _checkTheme() {
      ...
      this._themeItems.forEach(function (item) {
        if (item.getBoundingClientRect().top <= _this._header.offsetHeight && item.getBoundingClientRect().height + item.getBoundingClientRect().top > _this._header.offsetHeight) {
          if (_this._activeTheme === item.dataset.headerThemeClass) {
            return;
          }
          _this._header.classList.remove(_this._activeTheme);
          _this._activeTheme = item.dataset.headerThemeClass;
          _this._header.classList.add(_this._activeTheme);
        }
      });
    }
  }, {
    key: "_checkLogoColor",
    value: function _checkLogoColor() {
      var _this2 = this;
      this._colorTextItems.forEach(function (item) {
        if (item.getBoundingClientRect().top <= _this2._header.offsetHeight && item.getBoundingClientRect().height + item.getBoundingClientRect().top > _this2._header.offsetHeight) {
          if (_this2._activeTextColor === item.dataset.toggleColorClass) {
            return;
          }
          if (_this2._logo) {
            _this2._logo.classList.remove(_this2._activeTextColor);
            _this2._activeTextColor = item.dataset.toggleColorClass;
            _this2._logo.classList.add(_this2._activeTextColor);
          }
        }
      });
    }
  }, {
    key: "_checkBurgerColor",
    value: function _checkBurgerColor() {
      var _this3 = this;
      this._colorToggleItems.forEach(function (item) {
        if (item.getBoundingClientRect().top <= _this3._header.offsetHeight && item.getBoundingClientRect().height + item.getBoundingClientRect().top > _this3._header.offsetHeight) {
          if (_this3._activeToggleColor === item.dataset.toggleColorClass) {
            return;
          }
          if (_this3._burger) {
            _this3._burger.classList.remove(_this3._activeToggleColor);
            _this3._activeToggleColor = item.dataset.toggleColorClass;
            _this3._burger.classList.add(_this3._activeToggleColor);
          }
        }
      });
    }
...
exports.removeLogoColorClass = exports.addLogoColorClass = void 0;
var headerLogo = document.querySelector('[data-header-logo]');
var addLogoColorClass = function addLogoColorClass(color) {
  if (headerLogo) {
    headerLogo.classList.add("is-".concat(color));
  }
};
exports.addLogoColorClass = addLogoColorClass;
var removeLogoColorClass = function removeLogoColorClass(color) {
  if (headerLogo) {
    headerLogo.classList.remove("is-".concat(color));
  }
};
exports.removeLogoColorClass = removeLogoColorClass;
...
exports.initExhibitionsSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper.js"));
var _gsapMin = require("../vendor/gsap.min.js");
var _scrollTriggerMin = require("../vendor/scroll-trigger.min.js");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var MAX_TABLET_WIDTH = 1023;
var mySwiper = null;
var scrollAnimation = null;
var breakpoint = window.matchMedia("(max-width: ".concat(MAX_TABLET_WIDTH, "px)"));
var sectionWrapper = document.querySelector('.main-events');
var getDesktopSlider = function getDesktopSlider() {
  if (scrollAnimation) {
    scrollAnimation.kill();
  }
  _gsapMin.gsap.registerPlugin(_scrollTriggerMin.ScrollTrigger);
  if (sectionWrapper) {
    var section = sectionWrapper.querySelector('[data-section="horizontal"]');
    ...
    var horizontalTween = _gsapMin.gsap.to(content, {
      x: function x() {
        return -contentRect.width / 2 - 10;
      },
      ease: 'ease'
    });
    scrollAnimation = _scrollTriggerMin.ScrollTrigger.create({
...
var initMobileSlider = function initMobileSlider() {
  if (sectionWrapper) {
    ...
    mySwiper = new _swiper.default('.main-events__list-wrapper', {
      spaceBetween: 20,
      slidesPerView: 1,
      navigation: {
...
var initExhibitionsSlider = function initExhibitionsSlider() {
  if (breakpoint.matches) {
...
exports.initExhibitionsSlider = initExhibitionsSlider;
breakpoint.addEventListener('change', initExhibitionsSlider);

},{"../vendor/gsap.min.js":20,"../vendor/scroll-trigger.min.js":21,"../vendor/swiper.js":23}],8:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initHeaderThemeChange = void 0;
var _changeHeaderBg = require("./change-header-bg");
var initHeaderThemeChange = function initHeaderThemeChange() {
  var headerTheme = new _changeHeaderBg.HeaderTheme();
  headerTheme.init();
};
exports.initHeaderThemeChange = initHeaderThemeChange;

},{"./change-header-bg":5}],9:[function(require,module,exports){
"use strict";
...
var _swiper = _interopRequireDefault(require("../vendor/swiper.js"));
var _changeBurgerClass = require("./change-burger-class.js");
var _changeLogoClass = require("./change-logo-class.js");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var introSwiper = document.querySelector('.intro__swiper');
var introTextContainer = document.querySelector('.intro__text-container');
var addIntroTextContainerColorClass = function addIntroTextContainerColorClass() {
  if (introTextContainer) {
    introTextContainer.classList.add('intro__text-container--bright');
  }
};
var removeIntroTextContainerColorClass = function removeIntroTextContainerColorClass() {
...
var initIntroSlider = function initIntroSlider() {
  return new _swiper.default(introSwiper, {
    loop: true,
    speed: 1000,
    autoplay: {
      delay: 3000
    ...
    on: {
      slideNextTransitionStart: function slideNextTransitionStart() {
        ...
        if (activeSlideIndex === 3 || activeSlideIndex === 6) {
          (0, _changeBurgerClass.addBurgerColorClass)('white');
          (0, _changeLogoClass.addLogoColorClass)('white');
          addIntroTextContainerColorClass();
        } else {
          (0, _changeBurgerClass.removeBurgerColorClass)('white');
          (0, _changeLogoClass.removeLogoColorClass)('white');
...
},{"../vendor/swiper.js":23,"./change-burger-class.js":4,"./change-logo-class.js":6}],10:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initLampInstallationAnimation = void 0;
var _gsapMin = require("../vendor/gsap.min.js");
var artLampInstallationWrapper = document.querySelector('.art__lamp-installation-wrapper');
var lamps = document.querySelector('.art__lamp-installation-wrapper svg');
var MAX_TABLET_WIDTH = 1023;
var mouseCords = {
  x: 0,
  y: 0
...
var initLampInstallationAnimation = function initLampInstallationAnimation() {
  if (window.innerWidth > MAX_TABLET_WIDTH) {
    if (artLampInstallationWrapper && lamps) {
      ...
      var lampsMovement = lamps.dataset.movement;
      var lampsMovementDuration = lamps.dataset.duration;
      _gsapMin.gsap.to(lamps, {
...
exports.initLampInstallationAnimation = initLampInstallationAnimation;
_gsapMin.gsap.ticker.add(initLampInstallationAnimation);

},{"../vendor/gsap.min.js":20}],11:[function(require,module,exports){
"use strict";
...
var _gsapMin = require("../vendor/gsap.min.js");
var bustWrapper = document.querySelector('.sculptures__bust-wrapper');
var handWrapper = document.querySelector('.sculptures__hand-wrapper');
var initParallax = function initParallax() {
  if (bustWrapper && handWrapper) {
    var timeline = null;
    var setAnimation = function setAnimation() {
      timeline = _gsapMin.gsap.timeline({
        repeat: -1
      });
...
},{"../vendor/gsap.min.js":20}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.scrollToBlock = void 0;
    ...
    anchorElements.forEach(function (anchor) {
      anchor.addEventListener('click', function (evt) {
        ...
        if (scrollTarget && window.innerWidth < 1023) {
          ...
          if (href === '#exhibitions') {
            var contentRect = scrollTarget.getBoundingClientRect();
...
},{"./burger":3}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSmoothScroller = void 0;
var _gsapMin = require("../vendor/gsap.min.js");
var _scrollTriggerMin = require("../vendor/scroll-trigger.min.js");
_gsapMin.gsap.registerPlugin(_scrollTriggerMin.ScrollTrigger);
...
var initSmoothScroller = function initSmoothScroller() {
  var sections = Array.from(document.querySelectorAll('[data-section-animation]'));
...
exports.initSmoothScroller = initSmoothScroller;

},{"../vendor/gsap.min.js":20,"../vendor/scroll-trigger.min.js":21}],14:[function(require,module,exports){
"use strict";
...
var ANIMATION_STYLE_CLASSES = {
  MOBILE: 'splitting-block-mobile-animated',
  TABLET: 'splitting-block-tablet-animated',
  DESKTOP: 'splitting-block-desktop-animated'
};
var mobileBreakpoint = window.matchMedia("(max-width: ".concat(MAX_WIDTHS.MOBILE, "px)"));
var tabletBreakpoint = window.matchMedia("(min-width: ".concat(MAX_WIDTHS.MOBILE + 1, "px) and (max-width: ").concat(MAX_WIDTHS.TABLET, "px)"));
var splittingBlock = document.querySelector('.splitting-block');
var initSplitting = function initSplitting() {
  if (splittingBlock) {
    var _splittingBlock$class;
    // eslint-disable-next-line
    (0, _splittingMin.default)({
      target: '[data-splitting]',
      by: 'chars',
      key: null
    });
    (_splittingBlock$class = splittingBlock.classList).remove.apply(_splittingBlock$class, _toConsumableArray(Object.values(ANIMATION_STYLE_CLASSES)));
...
},{"../vendor/splitting.min.js":22}],15:[function(require,module,exports){
"use strict";
...
exports.initYMaps = void 0;
/* eslint-disable no-undef */
var initYMaps = function initYMaps() {
  var yandexMapsContainer = document.querySelector('#ymap');
  if (yandexMapsContainer) {
    ymaps.ready(function () {
      var myMap = new ymaps.Map(yandexMapsContainer, {
      ...
      var myPlacemarkMedium = new ymaps.Placemark(myMap.getCenter(), {
        hintContent: 'Dark Sight Art Gallery',
        balloonContent: 'Dark Sight Gallery',
        balloonContentHeader: '<a>Dark Sight Gallery</a>',
        balloonContentBody: '<img class="map__balloon-img" src="img/sprite/logo.svg">'
      ...
      var myPlacemarkSmall = new ymaps.Placemark(myMap.getCenter(), {
        hintContent: 'Dark Sight Art Gallery',
        balloonContent: 'Dark Sight Gallery',
        balloonContentBody: '<img class="map__balloon-img" src="img/sprite/logo.svg">'
      }, {
      ...
      we = se.onRelease = function (t) {
        if (!Xe(t, 1)) {
          ...
          !r && e && (se._vx.reset(), se._vy.reset(), s && Q && Se.delayedCall(.08, function () {
            if (300 < qe() - ye && !t.defaultPrevented) if (t.target.click) t.target.click();else if (ve.createEvent) {
